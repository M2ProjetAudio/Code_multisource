...
% Last Modified by GUIDE v2.5 17-Jan-2017 11:12:20
...
assignin('base','cas_de_figure',cas_de_figure);
fps=evalin('base','fps');
...
function Nbsources_Callback(hObject, eventdata, handles)
% hObject    handle to Nbsources (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of Nbsources as text
%        str2double(get(hObject,'String')) returns contents of Nbsources as a double
Q=str2double(get(hObject,'String'));
assignin('base','Q',Q);


% --- Executes during object creation, after setting all properties.
function Nbsources_CreateFcn(hObject, eventdata, handles)
% hObject    handle to Nbsources (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    empty - handles not created until after all CreateFcns called
...
function positions_Callback(hObject, eventdata, handles)
% hObject    handle to positions (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)

% Hints: get(hObject,'String') returns contents of positions as text
%        str2double(get(hObject,'String')) returns contents of positions as a double
Positions=str2double(get(hObject,'String'));
assignin('base','Positions',Positions);
